...
# vtex.io/cleaner-controller-bundle:$VERSION and vtex.io/cleaner-controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= vtex.io/cleaner-controller
...
ifeq (,$(shell which opm 2>/dev/null))
	...
	curl -ksSLo $(OPM) https://github.com/operator-framework/operator-registry/releases/download/v1.23.0/$${OS}-$${ARCH}-opm ;\
	chmod +x $(OPM) ;\
	}
else
OPM = $(shell which opm)
